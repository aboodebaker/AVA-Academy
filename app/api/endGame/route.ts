...
export async function POST(req: Request, res: Response) {
  try {
    ...
    await prisma.gamePerformance.create({
      data: {
        gameId: gameId,
...
1. Extract the necessary data from the database models 'Activity' and 'QuestionActivity' including, but not limited to, user ID, topic, gameType, question details, and performance metrics.

2. Analyze the extracted data to discern the user's academic strengths, weaknesses, question-level performance, and overall mastery of the subject matter.

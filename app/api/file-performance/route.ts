    ...
    const performance = await strict_output(
      ...
      `you are to analyse the student's perfromance here: ${gameString}`,
      {
        ...
        weaknesses: {
          ...
          analysis: "This is what should be given to the student to help him understand his weaknesses. Make bullet points. Always include."
        },
        topicAnalysis: {
...
**B. Areas for Improvement** 
   ...
   - analysis: Articulate the subjects and specific skills that data suggests require additional focus, extrapolated from recurring patterns where 'percentageCorrect' is low, including any 'options', 'userAnswer', and 'questionType' data that highlights a misunderstanding.

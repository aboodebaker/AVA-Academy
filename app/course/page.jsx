import CarouselItem from '@/components/carouselNotes/carasoul';
import SCarousel from '@/components/carouselNotes/searchcomponent'
...
const notes = await prisma.course.findMany({
    where: {
